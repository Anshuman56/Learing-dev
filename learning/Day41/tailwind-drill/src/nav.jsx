  ...
  return (
    <div className="bg-amber-200/23 py-3 px-6 border-b-2">
      <div className="md:max-w-7xl flex justify-around items-center mx-auto">
        <h1 className="font-bold cursor-pointer hidden md:block">My App</h1>
        ...
        <button className="bg-blue-400 cursor-pointer text-white hover:bg-blue-200 rounded font-bold transition md:block hidden px-8 py-2">
          Sign Up
        </button>
      </div>
    </div>
